...
public class CveDTO implements Serializable {
    ...
    private final static long serialVersionUID = -4688311848626347244L;
    ...
    public String toString() {
        return "CveDTO{" + "id=" + id + ", configuration=" + configuration + ", cwe=" + cwe + ", lastModifiedDate=" + lastModifiedDate + ", softwareList=" + softwareList + ", cvss=" + cvss + ", references=" + references + ", idCve=" + idCve + ", summary=" + summary + ", publishedDate=" + publishedDate + ", cveId=" + cveId + '}';
    }
